...
const EidCardPreview = ({
  ...
  return <div className="space-y-4">
      ...
      <div ref={cardRef} className="bg-white rounded-lg eid-card p-6 w-full max-w-md mx-auto">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mt-1">সালামি QR - সালামি দেন, সওয়াব কামান</p>
        </div>

        <div className="mt-6 grid grid-cols-2 gap-4">
          <div className="text-center">
            {profileImage ? <div className="mx-auto w-32 h-32 overflow-hidden rounded-md">
                <img src={profileImage} alt="Profile" className="w-full h-full object-cover" />
              </div> : <div className="mx-auto w-32 h-32 border-2 border-dashed border-gray-300 rounded-md flex items-center justify-center">
          ...
          <div className="text-center">
            {qrImage ? <div className="mx-auto w-32 h-32 overflow-hidden rounded-md bg-white p-1">
        ...
        {message && <div className="mt-4 p-3 bg-gray-50 rounded-md">
      ...
      <div className="flex flex-col sm:flex-row gap-2 justify-center mt-4">
        <Button onClick={handleDownloadImage} disabled={!hasRequiredFields} className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white">
          <Download className="mr-2 h-4 w-4" /> Download as Image
        </Button>
        <Button onClick={handleDownloadPDF} disabled={!hasRequiredFields} className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">
          <Download className="mr-2 h-4 w-4" /> Download as PDF
        </Button>
        <Button onClick={handleCopyLink} disabled={!hasRequiredFields} variant="outline">
          <Copy className="mr-2 h-4 w-4" /> Copy Link
        </Button>
      </div>

      {!hasRequiredFields && <p className="text-sm text-center text-amber-600">
